        ...
        <table className="w-full text-left text-sm">
          <thead className="bg-slate-900 text-white">
            <tr className="border-b border-slate-800">
              ...
              <th className="px-3.5 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-100">Discontinued At</th>
              <th className="px-3.5 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-100">Logs</th>
              <th className="px-3.5 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-100">Status</th>
            </tr>
          </thead>
